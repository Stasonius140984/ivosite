      ...
      <section className="relative py-16 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-12 shadow-2xl border-4 border-[#0039A6] max-w-4xl mx-auto">
            ...
            <h1 className="text-5xl mb-6 text-[#0039A6]">КАЖДЫЙ ГРАЖДАНИН - ЗАЩИТНИК ОТЕЧЕСТВА</h1>
            ...
            {onNavigate && (
              <div className="mt-8">
                <button
                  ...
                  className="bg-white hover:bg-blue-50 text-[#0039A6] px-8 py-4 rounded-lg shadow-xl transition-all hover:scale-105 inline-flex items-center gap-3 border-2 border-[#D52B1E]"
                >
