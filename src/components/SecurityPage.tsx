    ...
    <div className="w-full">
      ...
      <section className="relative py-16 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-12 shadow-2xl border-4 border-[#0055CC]">
            <Shield className="w-20 h-20 mx-auto mb-6 text-[#0055CC]" />
            <h1 className="text-5xl mb-6 text-[#0055CC]">ЧЕТКИЕ СЦЕНАРИИ ДЕЙСТВИЙ ДЛЯ ОХРАНЫ</h1>
            <p className="text-2xl text-[#E4181C]">Инструменты для мгновенного реагирования</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-4xl text-center mb-12 text-[#0055CC]">БЫСТРАЯ СПРАВКА</h2>
      ...
      <section className="relative py-16 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-4xl text-center">
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-12 shadow-2xl border-4 border-[#E4181C]">
            <Shield className="w-20 h-20 mx-auto mb-6 text-[#0055CC]" />
            <h2 className="text-3xl mb-6 text-[#0055CC]">ВАША ПРОФЕССИОНАЛЬНАЯ ОТВЕТСТВЕННОСТЬ</h2>
            <p className="text-xl mb-4 text-gray-800">Быстрая и правильная реакция охраны - основа безопасности объекта</p>
            <p className="text-[#E4181C]">Каждая секунда на счету. Каждое действие должно быть точным.</p>
          </div>
        </div>
      </section>
    </div>
