    ...
    <div className="w-full">
      ...
      <section className="relative py-16 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-12 shadow-2xl border-4 border-[#0055CC] max-w-4xl mx-auto">
            ...
            <h1 className="text-5xl mb-6 text-[#0055CC]">СИСТЕМА БЕЗОПАСНОСТИ С АВТОМАТИЧЕСКОЙ ЭСКАЛАЦИЕЙ</h1>
            <p className="text-2xl text-[#E4181C]">Ваша безопасность - наш приоритет</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <Card className="border-[#0055CC] border-2 hover:shadow-xl transition-all">
